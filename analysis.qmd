...
========================= */
::selection {
  background-color: #38bdf8 !important; /* Seçilen metnin arka planı gökyüzü mavisi */
  color: #ffffff !important; /* Seçilen metnin rengi KUSURSUZ BEYAZ */
}
::-moz-selection {
...
window.addEventListener('load', function() {
  setTimeout(function() {
    ...
    plots.forEach(function(plot, i) {
      ...
      // Create the explicit download button
      ...
      // Wire up the button to Plotly's native High-Res download API
      btn.onclick = function() {
        Plotly.downloadImage(plot, {format: 'png', width: 1920, height: 1080, scale: 2, filename: 'LetItHappen_Analytics_Chart_' + (i+1)});
      };
      
      // Insert button right above the plot
      wrap.appendChild(btn);
      plot.parentNode.insertBefore(wrap, plot);
    });
  }, 2500); // Wait 2.5 seconds to ensure htmlwidgets are fully rendered
});
</script>
```
