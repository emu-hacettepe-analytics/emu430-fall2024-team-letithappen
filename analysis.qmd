...
::selection {
  ...
  color: #0f172a !important; /* Seçilen metnin rengi lacivert */
}
::-moz-selection {
...
.hero-content h2 {
  ...
  font-weight: 400;
  margin-bottom: 2rem;
  color: #38bdf8 !important; /* Yazıyı çok net bir mavi yapar */
  text-shadow: 0 4px 10px rgba(0, 0, 0, 0.4); /* Arka plandan ayırır */
...
p_3d <- ie_combined %>%
  ...
  layout(
    ...
    scene = list(
      ...
      zaxis = list(title = "Rank (Lower is Better)", autorange = "reversed", gridcolor = "#cbd5e1", color = "#334155", tickformat = "d"),
      bgcolor = "transparent"
    ),
